...
public class Gmail {
    ...
    public class Users {
        ...
        public static func getProfile(userID: String = "me") -> AnyPublisher<Data, Error> {
        ...
        public static func stop(userID: String = "me") -> AnyPublisher<Data, Error> {
        ...
        public static func watch(userID: String = "me", requestBody: [String : Any]) -> AnyPublisher<Data, Error> {
    ...
    public class UsersDrafts {
        ...
        public static func create(userID: String = "me", type: API.resourceContentType, draft: [String : Any]) -> AnyPublisher<Data, Error> {
        ...
        public static func delete(userID: String = "me", id: String) -> AnyPublisher<Data, Error> {
        ...
        public static func get(userID: String = "me", id: String) -> AnyPublisher<Data, Error> {
        ...
        public static func list(userID: String = "me") -> AnyPublisher<DraftList, Error> {
        ...
        public static func send(userID: String = "me", headers: [String : String], draft: [String : Any], type: API.resourceContentType) -> AnyPublisher<Data, Error> {
        ...
        public static func update(userID: String = "me", draft: [String : Any], id: String, type: API.resourceContentType) -> AnyPublisher<Data, Error> {
    ...
    public class UsersHistory {
        ...
        public static func list(userID: String = "me", startHistoryId: String) -> AnyPublisher<Data, Error> {
    ...
    public class UsersLabels {
        ...
        public static func create(userID: String = "me", requestBody: Label) -> AnyPublisher<Label, Error> {
        ...
        public static func get(userID: String = "me", id: String) -> AnyPublisher<Label, Error> {
        ...
        public static func list(userID: String = "me") -> AnyPublisher<LabelList, Error> {
        ...
        public static func patch(userID: String = "me", id: String, requestBody: Label) -> AnyPublisher<Label, Error> {
        ...
        public static func update(userID: String = "me", id: String, requestBody: Label) -> AnyPublisher<Label, Error> {
    ...
    public class UsersMessages {
        ...
        public static func batchDelete(userID: String = "me", ids: [String]) -> AnyPublisher<Data, Error> {
        ...
        public static func batchModify(userID: String = "me", requestBody: UserMessagesBatchModifyBody) -> AnyPublisher<Data, Error> {
        ...
        public static func importMessage(userID: String = "me", type: API.resourceContentType, message: Message) -> AnyPublisher<Message, Error> {
        ...
        public static func insert(userID: String = "me", type: API.resourceContentType, message: Message) -> AnyPublisher<Message, Error> {
        ...
        public static func modify(userID: String = "me", id: String, modifiedMessageBody: ModifiedMessageBody) -> AnyPublisher<Message, Error> {
        ...
        public static func send(userID: String = "me", type: API.resourceContentType, message: Message) -> AnyPublisher<Message, Error> {
        ...
        public static func trash(userID: String = "me", id: String) -> AnyPublisher<Message, Error> {
        ...
        public static func untrash(userID: String = "me", id: String) -> AnyPublisher<Message, Error> {
        ...
        public static func list(userID: String = "me") -> AnyPublisher<MessagesList, Error> {
        ...
        public static func list(userID: String = "me") async -> MessagesList? {
        ...
        public static func get(userID: String = "me", id: String) -> AnyPublisher<Message, Error> {
    ...
    public class UsersThreads {
        ...
        public static func get(userID: String = "me", id: String) -> AnyPublisher<MailThread, Error> {
        ...
        public static func get(userID: String = "me", id: String) async -> MailThread? {
        ...
        public static func list(userID: String = "me", maxResults: Int?, pageToken: String?, query: String?, labelIDs: String?, includeSpamTrash: Bool?) -> AnyPublisher<ThreadList, Error> {
        ...
        public static func list(userID: String = "me", maxResults: Int?, pageToken: String?, query: String?, labelIDs: String?, includeSpamTrash: Bool?) async -> ThreadList? {
        ...
        public static func trash(userID: String = "me", id: String) -> AnyPublisher<MailThread, Error> {
        ...
        public static func untrash(userID: String = "me", id: String) -> AnyPublisher<MailThread, Error> {
        ...
        public static func modify(userID: String = "me", id: String, requestBody: ThreadModifyBody) -> AnyPublisher<MailThread, Error> {
    ...
    public class UsersSettings {
        ...
        public static func getAutoForwarding(userID: String = "me", id: String) -> AnyPublisher<AutoForwarding, Error> {
        ...
        public static func getImap(userID: String = "me") -> AnyPublisher<ImapSettings, Error> {
        ...
        public static func getLanguage(userID: String = "me") -> AnyPublisher<LanguageSettings, Error> {
        ...
        public static func getPop(userID: String = "me") -> AnyPublisher<PopSettings, Error> {
